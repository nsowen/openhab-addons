...
public interface Transport {
     ...
     */
    <T extends HomematicIPObject, V extends HomematicIPObject> CompletableFuture<Response<T, V>> postAsync(Request<T, V> request, Class<V> clazz, Executor executor);
     ...
     * @return a completable future with the response object, containing status code, body, runtime in millis.
     */
    <T extends HomematicIPObject, V extends HomematicIPObject> Response<T, V> post(Request<T, V> request, Class<V> clazz) throws IOException;
